...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo $GLOBALS['host']; ?>themes/<?php echo $GLOBALS['currTheme']; ?>/assets/basic/css/base2_inactive.css"/>
        ...
        <div id="footer_cont">
            ...
            <div id="footer_social">
                ...
                <p style='font-family: "Arial", sans-serif;'>This independent <span
                        style="color: #e62b1e; font-weight: bold;">TEDx</span> event is operated under license from
                <span style="color: #e62b1e; font-weight: bold;">TED</span>.</p>
            </div>
        </div>
    </div>
    <div id="top_strip">
        <div class="rel">
            ...
            <!--                        <a target="_blank" class="tickets_button" id="pc_tickets" href="-->
            <?php // echo $GLOBALS['host']; ?><!--tickets">-->
...
<a id="joinNow" href="<?php echo $GLOBALS['host']; ?>join">JOIN THE TEAM</a>
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
<script type="text/javascript"
        src="<?php echo $GLOBALS['host']; ?>themes/<?php echo $GLOBALS['currTheme']; ?>/assets/basic/js/base1_inactive.js"></script>
<?php
