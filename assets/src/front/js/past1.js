...
$(function()
{
  ...
  $(".past_speaker_single_thumb").on('click', function()
  {
    ...
    if(widthOne > 900)
    {
      ...
      widthOfVid = $(".speaker_single_content_right").eq(ind).width();
      heightofvid = widthOfVid * (315/560);
    }

    var yt_link = $(".speaker_single_content_right").eq(ind).attr("data-src");
    $(".speaker_single_content_right").html("<iframe width=\"" + widthOfVid + "\" height=\"" + heightofvid + "\" src=\"" + yt_link + "\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen></iframe>");
  });
