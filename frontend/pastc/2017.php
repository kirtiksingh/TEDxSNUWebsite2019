  ...
  <div id="past_speakers_display">
    ...
    <div id="past_speaker_content">
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/e5IBUoPmbvs?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">
					<a href="https://www.linkedin.com/in/abhineetsonkar" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/-vrnF1XREEc?rel=0&amp;controls=0&amp;showinfo=0">
			...
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/I1qnfY6GPmE?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">

					<a href="https://www.facebook.com/Bianca-Ghose-206386381947/" target="_blank"><i class="fab fa-facebook"></i></a>

					<a href="https://twitter.com/BiancaGhose?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank"><i class="fab fa-twitter"></i></a>
					<a href="https://in.linkedin.com/in/biancaghose" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/sweAQ-2nI1Y?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">

					<a href="https://www.facebook.com/GarimaAvtarRacing/" target="_blank"><i class="fab fa-facebook"></i></a>

					<a href="https://twitter.com/garimaavtar?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>
					<a href="https://in.linkedin.com/in/garima-avtar-749073a5" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/gFeX4QXcGuQ?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">

					<a href="https://www.facebook.com/karan.vaish.93" target="_blank"><i class="fab fa-facebook"></i></a>

					<a href="https://twitter.com/93vaish?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>
					<a href="https://in.linkedin.com/in/karan-vaish" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
					<h1>Nikheel Aphale</h1>
					<p>
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/gzJcYw6qE38?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">
					<a href="https://www.leehkin.com/ " target="_blank"><i class="fas fa-globe"></i></a>
					<a href="https://www.facebook.com/anikheel" target="_blank"><i class="fab fa-facebook"></i></a>
					<a href="https://www.instagram.com/leehkin/" target="_blank"><i class="fab fa-instagram"></i></a>
					<a href="https://twitter.com/anikheel" target="_blank"><i class="fab fa-twitter"></i></a>
					<a href="https://in.linkedin.com/in/nikheel-aphale-626a7b3 " target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/XRiTo64W8eI?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">

					<a href="https://twitter.com/rreema?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>

				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
					<h1>Reshma Valliapan</h1>
					<p>
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/owTmBYNwWZ4?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">
					<a href="https://www.valresh.com/ " target="_blank"><i class="fas fa-globe"></i></a>

					<a href="https://www.instagram.com/valresh/?hl=en" target="_blank"><i class="fab fa-instagram"></i></a>
					<a href="https://twitter.com/val_resh?lag=en" target="_blank"><i class="fab fa-twitter"></i></a>
					<a href="https://in.linkedin.com/in/reshmavalliappan" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/ok53Ow_oZ5k?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">

					<a href="https://in.linkedin.com/in/sanjayseth" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/7F9vu2Dc4HI?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">


					<a href="https://www.instagram.com/shreya__soni/?hl=en" target="_blank"><i class="fab fa-instagram"></i></a>

					<a href="https://in.linkedin.com/in/shreyasoni" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
					<h1>Sriram Raghavan</h1>
					<p>
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/4dY9K3cBXNg?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">
					<a href="https://twitter.com/sriramragh?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank"><i class="fab fa-twitter"></i></a>
					<a href="https://www.linkedin.com/in/rsram10/" target="_blank"><i class="fab fa-linkedin"></i></a>
			...
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/zpYo7YQOZSo?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">


					<a href="https://www.facebook.com/ZorianCrossProductions/" target="_blank"><i class="fab fa-facebook"></i></a>
					<a href="https://www.instagram.com/zizibello/?hl=en" target="_blank"><i class="fab fa-instagram"></i></a>
					<a href="https://twitter.com/ZorianCross?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank"><i class="fab fa-twitter"></i></a>
					<a href="https://in.linkedin.com/in/zoriancross" target="_blank"><i class="fab fa-linkedin"></i></a>
		...
		<div class="rel">
			<div id="slideshow_reel">
				<div class="slideshow_element">
						<img style="width: 100%;" src="<?php echo $GLOBALS['astLink'] ; ?>images/gallery_17/1.jpg">
				</div>
				<div class="slideshow_element">
						<img style="width: 100%;" src="<?php echo $GLOBALS['astLink'] ; ?>images/gallery_17/2.jpg">
				</div>
				<div class="slideshow_element">
						<img style="width: 100%;" src="<?php echo $GLOBALS['astLink'] ; ?>images/gallery_17/3.jpg">
				</div>
				<div class="slideshow_element">
						<img style="width: 100%;" src="<?php echo $GLOBALS['astLink'] ; ?>images/gallery_17/4.jpg">
				</div>
				<div class="slideshow_element">
