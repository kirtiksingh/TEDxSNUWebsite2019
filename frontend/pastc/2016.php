...
$GLOBALS['jsInclude'] = array("src/front/js/past1.js");
  ...
  <div id="past_speakers_display">
    ...
    <div id="past_speaker_content">
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/zSAHMZu6TOY?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">

					 <a href="https://www.instagram.com/ummrita/?hl=en" target="_blank"><i class="fab fa-instagram"></i></a>
					 <a href="https://twitter.com/amritamahale?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>
					 <a href="https://in.linkedin.com/in/amrita-mahale-1474497" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
					<h1>Anahita Dhondy</h1>
					<p>
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/-tH75fkJorc?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">
					<a href="http://www.anahitadhondy.com/" target="_blank"><i class="fas fa-globe"></i></a>
					<a href="https://www.facebook.com/ChefAnahitaDhondy/" target="_blank"><i class="fab fa-facebook"></i></a>
					<a href="https://www.instagram.com/anahitadhondy/?hl=en" target="_blank"><i class="fab fa-instagram"></i></a>

					<a href="https://www.linkedin.com/in/anahita-n-dhondy-61043831/?originalSubdomain=in" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
					<h1>Isher Ahluwalia</h1>
					<p>
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/Xbp83hiCwks?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">

					<a href="https://www.facebook.com/Isher-Judge-Ahluwalia-1653754288223317/" target="_blank"><i class="fab fa-facebook"></i></a>
			...
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="">

				</div>
				<div class="speaker_social_media">

					<a href="https://twitter.com/karunanundy?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>
			...
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/Sm2Ulzo7ALs?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">

					<a href="https://www.linkedin.com/in/laurajquinn" target="_blank"><i class="fab fa-linkedin"></i></a>
			...
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/IRTOrhWRcHM?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">
					<a href= "https://in.linkedin.com/in/pavitra-mohan-72bb831b" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
					<h1>Pernia Qureshi</h1>
					<p>
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/8r9gHxfYMqk?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">
					<a href="http://www.perniaqureshi.com/" target="_blank"><i class="fas fa-globe"></i></a>
					<a href="https://www.facebook.com/PerniaQureshi/" target="_blank"><i class="fab fa-facebook"></i></a>
					<a href=" https://twitter.com/perniaqureshi?lang=en " target="_blank"><i class="fab fa-twitter"></i></a>

					<a href="https://in.linkedin.com/in/jagdeep-chhokar-9b92162" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/ag0Z5f5JE5E?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">


						<a href="https://twitter.com/rameshmenon100?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>

					<a href="https://www.linkedin.com/in/journalistramesh/" target="_blank"><i class="fab fa-linkedin"></i></a>
				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
					<h1>Raul Villamarin Rodriguez</h1>
					<p>
			...
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/tAf_7diVL7U?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">


					<a href=" https://www.facebook.com/udayanbaijal" target="_blank"><i class="fab fa-facebook"></i></a>

					<a href="https://twitter.com/udayanbaijal?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>
					<a href="https://www.linkedin.com/in/udayan-baijal-2161741a/?originalSubdomain=uk" target="_blank"><i class="fab fa-linkedin"></i></a>
			...
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/nC1VYDhIcbA?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">
						<a href="https://www.vaibhavmehta.com/" target="_blank"><i class="fas fa-globe"></i></a>

					<a href="https://www.facebook.com/mehtavaibhav" target="_blank"><i class="fab fa-facebook"></i></a>

					<a href="https://twitter.com/mehtavaibhav" target="_blank"><i class="fab fa-twitter"></i></a>
					<a href="https://www.linkedin.com/in/mehtavaibhav/?originalSubdomain=in" target="_blank"><i class="fab fa-linkedin"></i></a>

				</div>
			</div>
			<div class="past_speaker_single_content">
				<div class="speaker_single_content_left">
					<h1>Jagdeep Chhokar</h1>
					<p>
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/g7WldsGDBpA?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">
					<a href="https://sites.google.com/site/jchhokar/" target="_blank"><i class="fas fa-globe"></i></a>
					<a href="https://www.facebook.com/jagdeep.chhokar" target="_blank"><i class="fab fa-facebook"></i></a>
					<a href="https://twitter.com/jagdeepchhokar?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>
			...
			<div class="past_speaker_single_content">
				...
				<div class="speaker_single_content_right" data-src="https://www.youtube.com/embed/sy8csBotG0I?rel=0&amp;controls=0&amp;showinfo=0">
					
				</div>
				<div class="speaker_social_media">

					<a href="http://karansinghmagic.blogspot.com/" target="_blank"><i class="fas fa-globe"></i></a>
					<a href="https://www.facebook.com/karansinghmagic/" target="_blank"><i class="fab fa-facebook"></i></a>
					<a href="https://twitter.com/karansinghmagic?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>
