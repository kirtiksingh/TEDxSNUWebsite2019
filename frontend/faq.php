  ...
  <link rel="stylesheet" href="<?php echo $GLOBALS['astLink'] ; ?>src/front/css/faq1.css">
	<div class="page_title_block">
		<div class="page_title_cont">
            <span class="page_title_white" style="font-size: 18px; color: #E53293">We have the answers</span><br>
  ...
  <div id="faq_container">
    <div class="faq_element">
      <div class="faq_element_header">
        <span class="faq_element_header_content">Q: What is TED and TEDx? How are they different?</span><i class="fas fa-chevron-down"></i>
      </div>
    ...
    <div class="faq_element">
      <div class="faq_element_header">
        <span class="faq_element_header_content">Q:  When and where will TEDxShivNadarUniversity take place this year? How long will it last, and will there be breaks in between?</span><i class="fas fa-chevron-down"></i>
      </div>
      <div class="faq_element_content">
        <p>
   ...
   <div class="faq_element">
      <div class="faq_element_header">
        <span class="faq_element_header_content">Q: Where can I watch the talks from the previous conferences?</span><i class="fas fa-chevron-down"></i>
      </div>
      <div class="faq_element_content">
        <p>
					A: <br>
    ...
    <div class="faq_element">
      <div class="faq_element_header">
        <span class="faq_element_header_content">Q: Are you employed by TED?</span><i class="fas fa-chevron-down"></i>
      </div>
      <div class="faq_element_content">
    ...
    <div class="faq_element">
      <div class="faq_element_header">
        <span class="faq_element_header_content">Q: Can people from outside Shiv Nadar University attend the conference?</span><i class="fas fa-chevron-down"></i>
      </div>
      <div class="faq_element_content">
    ...
    <div class="faq_element">
      <div class="faq_element_header">
        <span class="faq_element_header_content">Q: How and when can I buy tickets for the conference? </span><i class="fas fa-chevron-down"></i>
      </div>
      <div class="faq_element_content">
    ...
    <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: Why is there a cost to attend TEDxShivNadarUniversity?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: Are tickets refundable or transferable?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: What does the ticket cost include?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: Is there any age restriction on attendees of the conference?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: Is there any provision for transportation to and from the event venue for attendees from Delhi-NCR?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: Can I nominate someone to speak at the conference?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: Does TEDxShivNadarUniversity pay its speakers and performers?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: Are the talks at TEDxShivNadarUniversity curated?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: How is a TEDx conference different from any other conference (like JOSH talks or INK talks)?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: I have never attended a TEDx conference before. What should I expect?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: How long does the conference last? Will there be breaks in between the talks?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: What is the theme for the conference?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: How can my company get involved as a partner or sponsor of the conference?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
      ...
      <div class="faq_element">
        <div class="faq_element_header">
          <span class="faq_element_header_content">Q: Is there any way to receive regular updates and news about your conference?</span><i class="fas fa-chevron-down"></i>
        </div>
        <div class="faq_element_content">
