...
$GLOBALS['printPage'] = function()
{
    ...
    <div id="top_poster_two">
        ...
        <div class="right_bar">
            <a class="nominate_a_speaker" target="_blank" href="https://goo.gl/forms/9x9EWTLjptZmLbQF2">
                <i class="fas fa-external-link-alt"></i>  BOOK NOW
            </a>
        </div>
        <hr/>
        <div class="left_bar">
            <span>18th November 2018</span><span><i class="fas fa-clock"></i> 9:00 to 18:00 </span><span> | </span><span><i class="fas fa-rupee-sign"></i> 1000 onwards</span>
        </div>
    </div><br>
    <div id="table_holder">
                ...
                <div class="resp_cell" id="bigger">
                    ...
                    <table style="width: 100%; table-layout: fixed">
                        ...
                        <tr style="font-size: 18px;">
                            ...
                            <td><i class="fas fa-rupee-sign"></i>1000</td>
                            <td><i class="fas fa-rupee-sign"></i>1400</td>
                        </tr>
                    </table>
                    ...
                    <div class="table_table">
                        <div class="table_row">
                            <div class="table_cell">
                                ...
                                <h3 style=" line-height: 125%; font-size: 20px; font-weight: normal; margin-top: 0; margin-bottom: 3px;">A TED-like journey of 44 days</h3><hr class="styled_hr">
