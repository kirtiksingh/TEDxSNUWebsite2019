...
$GLOBALS['printPage'] = function()
{
	...
	<div class="page_title_block">
		<div class="page_title_cont">
			<span class="page_title_white">OUR</span><span class="page_title_red"> SPEAKERS</span>
			<p>
                          ...
                          <div class="speakers_element_content">
                            <div class="rel">
                                ...
                                <div class="speakers_element_content_andar_ka_content">
                                    ...
                                    <h1>Kapil Dev</h1>
                                    <h2>Cricketing Legend</h2>
                                    <p>
                                        The year is 1983, it is the world cup final, India has lost the toss to one of the best bowling attacks in the world. 183 runs, it's not enough, but something happens- a miracle, a victory, the first for India. Led by one of the most humble cricketers to grace Indian Cricket, who would later go on to be an icon for an era. A man of utmost simplicity whether his focus on cricket or his approach to life.
</p><p>
A captain for some, a hero for the others and a legend for everyone. One of the greatest all-rounders to have ever played the game. It gives us immense pleasure to announce that Mr. Kapil Dev will be speaking at TEDxShivNadarUniversity on 18th November 2018.
                                    </p>
                          ...
                          <div class="speakers_element_content">
                            <div class="rel">
                                ...
                                <div class="speakers_element_content_andar_ka_content">
																	<i class="fas fa-times cross_it"></i>
                                    <h1>Vasu Primlani</h1>
                                    <h2>Somatic Therapist | Comedian</h2>
                                    <p>
																...
																<div class="speakers_element_content_andar_ka_content">
																	<i class="fas fa-times cross_it"></i>
																		...
																		<p>
																			...
																			This 18th of November, witness what it is like to lose yourself to the magic of words, the charm of her poetry and let her teach you the art of asking the right questions. </p>
																		<div class="speaker_social_media">
										...
										<div class="rel">
												...
												<div class="speakers_element_content">
													<div class="rel">
															...
															<div class="speakers_element_content_andar_ka_content">
																<i class="fas fa-times cross_it"></i>
																	<h1>Nila Madhab Panda</h1>
																	<h2>Director | Producer</h2>
																	<p>
																	    Filmmaking is perhaps an expression of art which appeals to most because it creates surreality out of the mundane. What happens when the same medium is used to portray reality in its truest form? Not many understand it. </p>
                                                                    <p>
Our next speaker - Mr. Nila Madhab Panda is one filmmaker whose work transcends barriers and speaks of socially relevant themes wrapped in his splendid way of storytelling. Recipient of the Padma Shri award and numerous others from across the globe, he has produced and directed over 70 diverse and cutting-edge films and documentaries with 'I am Kalam' and 'Jalpari' being the most widely appreciated ones.
This 18th of November, hear him talk about how he "accidentally" became a storyteller and allow him to take you on a journey closer to his artistic vision.
																    </p>
																	<div class="speaker_social_media">

																		<a href="https://www.facebook.com/NilaMadhabPanda/" target="_blank"><i class="fab fa-facebook"></i></a>
																		<a href=" https://twitter.com/nilamadhabpanda" target="_blank"><i class="fab fa-twitter"></i></a>
																		<a href="https://www.linkedin.com/in/nila-madhab-panda-7685823/?originalSubdomain=in" target="_blank"><i class="fab fa-linkedin"></i></a>
																	</div>
															</div>
													</div>
												</div>
                            ...
                            <div class="rel">
                                <i class="notch_arrow fas fa-sort-up"></i>
																<div class="speakers_element_content_andar_ka_content">
																	<i class="fas fa-times cross_it"></i>
																		<h1>Sohail Hashmi</h1>
																		<h2>Historian, Heritage Walk Curator</h2>
																		<p>
																		Have you ever been to Lodhi Gardens - the popular 'picnic spot' in Delhi? Do you know it has the tombs of Sikander Lodi and Muhammad Shah? Or that the famous “Paranthe wali Gali” in Chandni Chowk was established in 1650 during the reign of the Mughal Emperor - Shah Jahan?</p>
<p>We have somebody whose knowledge goes as far and wide as the city’s expanse and whose personality exudes the long-lost essence of Delhi. Mr. Sohail Hashmi, an academician, historian, and a filmmaker is well-known for vividly reconstructing the glorious past of the city through the immersive heritage walks that he conducts around the capital. Narrations of his lived experiences, which are interestingly inextricable from the city’s history, leave everyone craving for more.</p>
<p>On 18th of November - hear him talk about the indispensable association between Democracy and Dissent, buried in the roots of the heritage of our country.</p>
																		<div class="speaker_social_media">
                            ...
                            <div class="rel">
                                <i class="notch_arrow fas fa-sort-up"></i>
																<div class="speakers_element_content_andar_ka_content">
																	<i class="fas fa-times cross_it"></i>
																		<h1>Yogesh Saini</h1>
																		<h2>Founder, Delhi Street Art</h2>
																		<p>
																			Dilli is known to be a city for those with a heart and larger than life soul but in modern days everyone is constantly complaining about the smell, the air, and the litter that crowds the streets. With all the initiatives and efforts being started to clean Delhi up, an initiative deserves special mention for adding colour and culture to this downtrodden city of ours.</p>
<p>The Delhi Street Art Gallery was started in 2013 by Mr. Yogesh Saini with the goal to add more colour to Delhi’s open spaces, give local artists a creative outlet to express themselves and to encourage citizens to keep their public spaces clean while appreciating art. And what is better than a little bit of art to feed the soul?</p>
<p>Catch him live on the 18th of November talking about how art can make our cities more breathable and transform everything as we know it.</p>
																		<div class="speaker_social_media">
                            ...
                            <div class="rel">
                                <i class="notch_arrow fas fa-sort-up"></i>
																<div class="speakers_element_content_andar_ka_content">
																	<i class="fas fa-times cross_it"></i>
																		<h1>Karan Suri</h1>
																		<h2>Executive Director, Morgan Stanley</h2>
																		<p>
...
This 18th of November hear her delve into the importance and intricacies of empathy at TEDxShivNadarUniversity.</p>
													...
													<div class="speakers_element_content">
														<div class="rel">
																...
																<div class="speakers_element_content_andar_ka_content">
																	<i class="fas fa-times cross_it"></i>
																		<h1>NG Jayasimha</h1>
																		<h2>Managing Director, Humane Society International</h2>
																		<p>
														...
														<div class="rel">
																...
																<div class="speakers_element_content_andar_ka_content">
																	<i class="fas fa-times cross_it"></i>
																		...
																		<h2>Journalist</h2>
																		<p>
n a nation that boasts of unparalleled diversity, there exist myriad faces of politics and uncountable individualities. Here is a lady who has spent her entire professional career exposing political truths via commentary and presenting public figures in a new light and highlighting counter-narratives through conversations. 
</p><p>
                                ...
                                <i class="notch_arrow fas fa-sort-up"></i>
																<div class="speakers_element_content_andar_ka_content">
																	<i class="fas fa-times cross_it"></i>
																		...
																		<h2>Performer - Musical Artist</h2>
																		<p>
